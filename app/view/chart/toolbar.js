          ...
          items: [
            {
              ...
              items: [
                        ...
                        success: function(response, opts) {
                          ...
                          Ext.Ajax.request({
                            ...
                            success: function(response, opts) {
                              ...
                              datefield.setValue(
                                new Date(
                                  minDate.substring(0, 4),
                                  minDate.substring(5, 7) - 1,
                                  minDate.substring(8, 10),
                                  minDate.substring(11, 13),
                                  0,
                                  0,
                                  0
                                )
                              ...
                              datefield.setMaxValue(
                                new Date(
                                  ...
                                  maxDate.substring(5, 7) - 1,
                                  maxDate.substring(8, 10),
                                  maxDate.substring(11, 13),
                                  0,
                                  0,
                                  0
                                )
                ...
                {
                  reference: "AggregationButton",
                  xtype: "segmentedbutton",
                  items: [
                    {
                      text: "Hourly",
                      inputValue:
                        "[-0.041], [-0.125], [-0.25], [-0.5], [-0.75], [-1], [-2], [-3], [-4], [-5]",
                      defaultPeriod: "-0.041",
