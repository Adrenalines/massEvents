Ext.define('Visualisation.Main', {
    ...
    listeners: {
                              render: function(element){
                                ...
                                if (timeliness_net_alert.globals.Constants.loaded_stores == timeliness_net_alert.globals.Constants.total_stores
                                && !timeliness_net_alert.globals.Constants.charts_is_loading){
        ...
        items: [
           {
                  ...
                  items: [
                       ...
                       {
                            text: 'Текущий недельный отчет',
                            name: 'link',
                            margin: '6 0 5 5',
                            tooltip: 'Выгрузить текущий недельный отчет в формате Excel',
                            fieldInStaticJson: 'current_report_url',
                            url: '',
                            listeners: {
